...
import verseReferenceData from "./mocks/verseReferenceJohnChapter3Verse16.json" with { type: "json" };
import verseOfTheDayData from "./mocks/verseOfTheDay2PeterChapter3Verse7.json" with { type: "json" };
